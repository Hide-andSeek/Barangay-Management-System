...
<?php 
$f = "resources/bpermit_visit_new.php";
if(!file_exists($f)){
	touch($f);
	$handle =  fopen($f, "w" ) ;
	fwrite($handle,0) ;
...
<div class="document_section">
	<section>
        ...
        <blockquote class="blockqoute-color" style="text-align: justify;">
            <p class="reminder"><label class="reminder-heading" >Reminder: </label> This is for Business Permit <strong> (New)</strong>, fill out this form and submit along with your valid id. Once approved, pay the corresponding fees this will vary depending on the nature of your business. Get the official copy of your Business Permit via Gmail. <i> <strong> Tagalog Translation</strong>, ito ay para sa Business Permit <strong> (New)</strong>, punan ang form na ito at isumite kasama ang iyong valid id. Kapag naaprubahan na, bayaran ang kaukulang bayarin, ito ay mag-iiba depende sa uri ng iyong negosyo. Kunin ang opisyal na kopya ng Business Permit sa Gmail. </i> <strong> Form for Renewal Business Permit, visit <a href="reqdoc_bpermit.php"> (here)</a></strong>
			<br>
			</p>
			<?php echo $visitt ;?>
        </blockquote>
    <fieldset class="left_userpersonal_info">
																<div>
																	...
																	<label>Listahan ng mga ipapasang dokumento <a href="reqdoc_barangayid.php#barangayid"> (Business Permit)</a></label>
																		<ol style="padding: 15px 15px 15px 15px; text-align: justify;">
																	...
																	<label>List of documents to be submitted  <a href="reqdoc_barangayid.php#barangayid"> (Business Permit)</a></label>
																		<ol style="padding: 15px 15px 15px 15px; text-align: justify;">
												...
												<form method="POST" enctype="multipart/form-data" action="" autocomplete="on">
                                                            <hr>
															    <h5 style="text-align: center;" id="barangayid">Application form for New Business Permit</h5>
														    <hr>
            ...
            <p class="reminder"><label class="reminder-heading">Reminder/ Tagubilin: </label> Fill out the information below. Your information will appear in the document you request. Please check before submitting, to avoid typographical errors (misspelled names). <em> <strong> Tagalog Translation:</strong> Punan ang impormasyon sa ibaba. Ang iyong impormasyon ay lalabas sa dokumento na iyong hinihiling. Pakisuri muna bago ito isumite. Upang maiwasan ang typographical error (misspelled names).</em></p> 
															...
															<div class="left_userpersonal_info left_userpersonal_info1">            
																...
																<div class="form-group">
																	...
																	<i aria-details="businessid_image" class="detailid"><label>please attach VALID ID and 2x2 PICTURE in the right format (.docx)<?php echo isset($error['businessid_image']) ? $error['businessid_image'] : '';?></label></i>
																</div><br>
															...
															<div class="left_userpersonal_info left_userpersonal_info1">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <br>
																	<input type="text" class="form-control form-text usersel" id="selection" name="selection" value="new" readonly>
													...
													Q1. Where is the form for Business Permit (Renewal)? Click <a href="reqdoc_bpermit.php"> here</a>
													</p>
													<div style="display: flex; justify-content: center; align-items: center;">
														<button class="button form-control" name="permitBtnnew"><span>Submit </span>
													</button>
													</div>
												</div>
											</div>
