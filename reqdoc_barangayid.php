...
<div class="document_section">
	<section>
        <h2>Barangay ID</h2>
        <p><a href="residentreqdocu.php">Home </a>>> <a href="instructions.php"><strong> Barangay ID </strong></a>
        <hr>
        <blockquote class="blockqoute-color">
            <p class="reminder"><label class="reminder-heading">Reminder: </label> Upon requesting your document, please expect around 5 to 15 minutes waiting time.</p>
        </blockquote>
    <fieldset class="left_userpersonal_info">
																<div>
																	...
																	<ol style="padding: 15px 15px 15px 15px">
																		...
																		<li>I-save ang iyong file sa <strong style="color: red">docx </strong> format.</li>
																	...
																	<ol style="padding: 15px 15px 15px 15px">
																		...
																		<li>Save your file in <strong style="color: red">docx</strong> format.</li>
															...
															<div class="left_userpersonal_info left_userpersonal_info1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control form-text form-text-desc" id="fname" name="fname" placeholder="Please write your First name" onkeyup="var start = this.selectionStart; var end = this.selectionEnd;this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);">
                                            ...
                                            <br>
                                            <a href="index.php">
                                                <p style="float: left; margin-left: 20px;"><i class="bx bx-skip-previous"></i> Home</p>
                                            </a>
                                            <a href="businesspermit.php">
												<p style="float: right; margin-right: 20px;">Business Permit <i class="bx bx-skip-next"></i></p>
                                            </a>
                                            <br>
                                            <br>
                                            <br>
