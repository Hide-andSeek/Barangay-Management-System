                        ...
                        <form method="POST" action="">
                            <div class="margin" >
                                ...
                                <div class="margin">
                                    ...
                                    <input type="hidden" id="document_type" value="Barangay Clearance" class="form-control inpmargin usersel" name="document_type" readonly>
                                ...
                                <div class="but">
                                <button class="button form-control" name="clearancepaymentbtn"><span>Submit </span><button>
                                </div>
