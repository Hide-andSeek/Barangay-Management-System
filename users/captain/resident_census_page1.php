		...
		<div id="content" class="container col-md-12">
				<div id="London" class="w3-container city" style="margin-top: 50px;">
					<form class="form-signin" method="POST">
                        <h5 style="margin-left: 20px;">Add Family Member 1</h5>
				...
				<hr>
						...
						<div class="row align-items-start" style="margin-left: 16px;">
							<div class="information col">
								...
								<a class="btn btn-success btnwidth" name="proceed" href="resident_census_page_2.php" style="margin-bottom: 10px;"><i class="icon-save icon-large"></i> Proceed </a>
								<br>
                                <br>
                                <br>
								<label>Page > <strong> Page 1 </strong></label>
							</div>
						</div>
					</form>
				</div>
