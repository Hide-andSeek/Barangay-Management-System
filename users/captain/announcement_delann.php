			...
			<!-- Top Section -->
			  <section class="top-section">
				  <div class="top-content">
					<div>
						<a href="postannouncement.php" style="text-decoration: none; color: white;">Post Announcement</a><label> >> </label><a href="#" style="text-decoration: underline; color: black;">Delete Announcement</a>
						<a href="#" class="circle">
							 <img src="img/dt.png" >
					    </a>	  
					</div>
				...
				<div id="content" style="text-align: center;" class="container font-sizee col-md-12">
					...
					<form method="post">
						...
						<input type="submit" class="btn btn-danger font-sizee " value="Yes" name="btnDeleteAnnouncement"/>
						<a class="btn btn-success font-sizee " href="postannouncement.php">No</a>
					</form>
