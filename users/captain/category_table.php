							...
							<div class="search_content">
								<form class="list_header" method="get">
									...
									<label class="select__select">
										New Category: 
										<button class="page-scroll login hoverbtn" onclick="document.getElementById('add_<?php echo $data['cid']; ?>').style.display='block'">
...
<div id="content" class="container col-md-12">
					...
					<hr/>
						<h5>Announcement <strong style="color: red; font-size: 15px;"> Not Available.</strong>  Please Add New Announcement. Just Click
							<a class="page-scroll login hoverbtn" style="cursor: pointer; font-size:15px;" onclick="document.getElementById('noannouncement_<?php echo $data['aid']; ?>').style.display='block'">
							here
							</a>
						</h5>
					<hr/>
			...
			<hr /> 
					...
					<div class="search_content">
								<form class="list_header" method="get">
									...
									<label class="select__select">
										New Announce: 
										<button class="page-scroll login hoverbtn" onclick="document.getElementById('addannounce_<?php echo $data['aid']; ?>').style.display='block'">
											<i class="bx bx-plus-circle" style="font-size: 16px;"></i> Click to Add
										</button>
										<button style="background: none;"><i style="color: gray; font-size: 21px;" class="bx bx-help-circle bcircle"></i></button>
									</label>
