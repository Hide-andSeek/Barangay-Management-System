...
<?php 
	if(isset($_POST['btnAdd'])){
		...
		// upload new image
		$upload = move_uploaded_file($_FILES['category_image']['tmp_name'], 'img/fileupload_announcement/'.$menu_image);
		...
		if(isset($_POST['btnEdit'])){
			...
			if(!empty($category_name) && empty($error['category_image'])){
				...
				if(!empty($menu_image)){
					...
					$delete = unlink('img/fileupload_announcement/'."$previous_category_image");
					
					// upload new image
					$upload = move_uploaded_file($_FILES['category_image']['tmp_name'], 'img/fileupload_announcement/'.$category_image);
