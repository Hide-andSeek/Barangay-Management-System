		...
		<div class="w3-row-padding w3-margin-bottom">
			...
			<div class="w3-container w3-teal w3-padding-16">
				...
				<?php 
					...
					$query = "SELECT admincomp_id FROM admin_complaints WHERE status = 'Pending' AND dept = 'VAWC' ORDER BY admincomp_id";
					$query_run = $db->query($query);
					$pdoexecute = $query_run->rowCount();
			...
			<div class="w3-container w3-orange w3-text-white w3-padding-16">
				...
				<?php 
					...
					$query = "SELECT admincomp_id FROM admin_complaints WHERE status = 'Closed' AND dept = 'VAWC' ORDER BY admincomp_id";
					$query_run = $db->query($query);
					$pdoexecute = $query_run->rowCount();
						...
						while ($stmt_paging->fetch()) { ?>
							<tbody>
								<tr class="table-row">
									...
									<td><button class="view_approvebtn" onclick="location.href='vawc_appdetails.php?id=<?php echo $data['admincomp_id']; ?>'">View Details</button></td>
