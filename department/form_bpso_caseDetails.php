					...
					<div class="row" style="margin-left: 40px; margin-right: 50px;">
						<div class="col-lg-12">
							<div class="form-group mb-3" style="width: 100%; height: auto;">
								...
								<input type="text" style="font-size: 13px;" class="form-control" name="dept" id="dept" value="<?php echo $row['dept']; ?>" disabled>
							</div>
							<div class="form-group mb-3" style="width: 100%; height: auto;">
								<label for="app_date">Approval Date:</label>
								<input type="text" style="font-size: 13px;" class="form-control" name="app_date" id="app_date" value="<?php echo $row['app_date']; ?>" disabled>
							</div>
							<div class="form-group mb-3" style="width: 100%; height: auto;">
								<label for="app_by">Approved By:</label>
								<input type="text" style="font-size: 13px;" class="form-control" name="app_by" id="app_by" value="<?php echo strtoupper($row['app_by']); ?>" disabled>
							</div>
