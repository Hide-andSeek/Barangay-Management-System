...
<head>
	...
	<title>Equipment Expenses: Accounting Dept. </title>
	...
	<section class="home-section">
		...
		<section class="top-section">
			<div class="top-content">
				<div>
					<h5>Equipment Expenses >> View Details
						<a href="#" class="circle">
							<img src="../img/dt.png">
						</a>
					</h5>
		...
		<div id="content" class="container col-md-12">
			...
			<div>
				...
				<div id="London" class="w3-container city" style="margin-top: 50px;">
					<hr>
					<h5 style="text-align: center;">Equipment Expenses</h5>
					<hr>
					<div class="col-md-12">
						<table id="viewdetails" style="margin-bottom: 30px; margin-top: 30px; text-align: center;">
							<?php
							$query = $db->query("SELECT * FROM equip_budget ORDER BY id ASC");
							?>
						...
						<div style="float: right; margin-right: 50px;">
							<label for=""><strong> Total: </strong> ₱<?php echo $equip_total_amount; ?></label>
						</div>          
					</div>
					<br>
					<form method="POST" action="">
						<div class="row align-items-start">
							<div class="information col">
								<label class="employee-label">Equipment Name:</label>
								<input class="form-control inputtext widthinp" type="text" onkeyup="var start = this.selectionStart; var end = this.selectionEnd;this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" name="name" placeholder="Please specify equipment name">              
							</div>
						...
						<br>
						<a><button class="font-sizee form-control btnmargin button" name="equipmentsave" id=""><span>Submit </span></button></a>
					</form>
				</div>
			</div>
