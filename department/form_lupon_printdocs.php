			...
			<!-- Top Section -->
										...
										<div style="padding-top: 15px; width: 965px;  height: 344px;">
											<div style="display: flex;">
												...
												<h5><b> Republika ng Pilipinas</b></h5>
          <h5 class="w3-opacity"><b> TANGGAPAN NG PUNONG BARANGAY</b></h5>
          <h5 class="w3-opacity"><b> BARANGAY COMMONWEALTH</b></h5>
          <h5 class="w3-opacity"><b><Lungsod Quezon, Metro Manila></b></h5>
          <h5 class="w3-opacity"><b>Tel.No: 427-9210/Telefax No. 951-7912</b></h5>
          <h2 class="w3-text-black">OFFICE OF THE LUPONG TAGAPAMAYAPA</h2>
			
		 										<img style=" display: flex; float: right;  margin-left: 1px; padding-left: 100px; " class="commonwealthlogo" src="resident-img/Brgy-Commonwealth_1.png">
</div>
		</div>
