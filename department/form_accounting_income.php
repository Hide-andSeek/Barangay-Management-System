...
<head>
	...
	<section class="home-section">
		...
		<div id="content" class="container col-md-12" style="margin-left: 50px; margin-right: 50px;">
			<?php
			...
			<div>
				...
				<br>
				<div id="London" class="w3-container city" style="margin-top: 50px;margin-right: 90px;" >
					<hr>
					<h5 style="text-align: center;">Total Income (Document Request)</h5>
					<hr>
					...
					<div class="col-md-12">
							<table id="viewdetails" style="margin-bottom: 30px; margin-top: 30px; text-align: center;" >
								<thead>
									<tr class="t_head" style="text-align: center;">
                                        ...
                                        <th width="15%" style="text-align: center;">Document Type</th>
						...
						?>
                            ...
                            <div style="float: right; margin-right: 50px;">
                                <label for=""><strong> Total: </strong>₱ <?php echo $total_amount; ?></label>
                            </div>
