	...
	<!-- Side Navigation Bar-->
		  <div class="sidebar">
            ...
            <li>
			 ...
			 <li>
			   <a class="side_bar nav-button nav-active" href="compAdmin_BCPC.php">
          ...
          <div id="ssms" class="modal">
                ...
                <div class="information col">
						<label class="employee-label ">Approval Date </label>
							<input type="text" class="form-control inputtext control-label usersel" id="app_date" value="<?php echo $data['app_date']; ?>"  style="padding: 5px;" name="app_date">
					</div>

			        <div class="information col">
						<label class="employee-label"> Approved By </label>
							<input class="form-control inputtext control-label usersel"  style="padding: 5px;" id="app_by" name="app_by" value="<?php echo $data['app_by']; ?>" type="text"> 
                    </div>
                    <br>
