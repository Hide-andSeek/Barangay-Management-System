		...
		<!-- Side Navigation Bar-->
		  ...
		  <section class="home-section">
            ...
            <br>
                    ...
                    <strong>
                        <textarea class="form-control inputtext" style="padding: 50px; background: #D6EACA; text-align: justify;" disabled="disabled" id="" cols="175" rows="7"><?php echo $data['complaints']; ?></textarea>
        ...
        <hr>
                    <table id="viewdetails" style="margin-bottom: 30px; margin-top: 30px;">
						...
						<?php	
							...
							$mquery = "SELECT * FROM bpsodb WHERE admincomp_id = $ID";
