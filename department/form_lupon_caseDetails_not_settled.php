...
<head>
	...
	<title> Lupon Not Settled Case Details </title>
	...
	<section class="home-section">
		...
		<section class="top-section">
			<div class="top-content">
				<div>
					<h5>OFFICE OF THE LUPONG TAGAPAMAYAPA > View Details
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group mb-3" style="width: 100%; height: auto;">
									...
									<input type="text" class="form-control" style="font-size: 13px;" name="dept" id="dept" value="<?php echo $row['dept']; ?>" disabled>
								</div>
								<div class="form-group mb-3" style="width: 100%; height: auto;">
									<label for="app_date">Approval Date:</label>
									<input type="text" class="form-control" style="font-size: 13px;" name="app_date" id="app_date" value="<?php echo $row['app_date']; ?>" disabled>
								</div>
								<div class="form-group mb-3" style="width: 100%; height: auto;">
									<label for="app_by">Approved By:</label>
									<input type="text" class="form-control" style="font-size: 13px;" name="app_by" id="app_by" value="<?php echo $row['app_by']; ?>" disabled>
								</div>
							</div>
						</div>
					</div>
