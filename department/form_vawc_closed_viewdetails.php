...
<head>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-list">
			 ...
			 <li>
			   <a class="side_bar nav-button nav-active" href="vawc_closed.php">
    ...
    <section class="home-section">
        ...
        <section class="top-section">
            <div class="top-content">
                <div>
                    <h5>Dashboard >> Closed Case >> View Details
                        <a href="#" class="circle">
                            <img src="../img/dt.png">
                        </a>
                    </h5>
                            ...
                            <form method="POST" action="../send_sms.php" class="body">
                                <div class="main-content-email">
                                    ...
                                    <div class="main-content">
                                        <div class="information col">
                                            <p> Fullname: </p>
                                            <input class="form-control emailwidth" id="fullname" name="fullname" value="<?php echo $data['n_complainant']; ?>" type="text" placeholder="Enter Fullname"> l;
                                        </div>
