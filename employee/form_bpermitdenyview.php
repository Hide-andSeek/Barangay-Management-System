                ...
                <div style="float: right;">
                    ...
                    <table id="viewdetails" class="font-sizee">
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['permitfilechoice']; ?></td>
                        </tr>
                    </table>
                    </div>
                    <br>
                    <form method="POST" action="" class="body" enctype="multipart/form-data">
                                        <div class="main-content-email">
                                            ...
                                            <div class="main-content">
                                                ...
                                                <div class="information col">
                                                    <p> To: </p>
                                                    <input required class="form-control emailwidth" id="email" name="email" value="<?php echo $data['email_add']; ?>" type="text" placeholder="Enter Email Address">
                                                </div>
                                            </div>
                                            <div class="main-content">
                                                <div class="information col">
                                            ...
                                            <div class="information">
                                                <p>Body: </p>
                                                <textarea name="message" id="message" rows="32" placeholder="Your message" style="margin-right:5%"></textarea>
                                            ...
                                            <div class="sendi">
                                                <button name="denysendmail" class="form-control viewbtn" style="margin-bottom: 10px;margin-top: 10px; width: 95%; cursor: pointer;"><span class="glyphicon glyphicon-envelope"></span> Send <i class="bx bx-send"></i></button>
                                            </div>
                                        </div>
                                    </form>         
