...
<head>
    ...
    <title> Barangay Clearance - Transaction History</title>
    ...
    <section class="home-section">
        ...
        <section class="top-section">
            <div class="top-content">
                <div>
                    <h5>Barangay Clearance >> Transaction History
                        <a href="#" class="circle">
                            <img src="../img/dt.png">
                        </a>
                    </h5>
        ...
        <div id="content" class="container col-md-12">
            ...
            if (empty($keyword)) {
                $sql_query = "SELECT approved_clearanceids, full_name, age, status, nationality, address,contactno, emailadd, purpose,date_issued, ctc_no, issued_at, precint_no, clearanceid_image, filechoice, approvedby, app_date, clearance_status, payment_stat
					FROM approved_clearance WHERE clearance_status = 'Done'
            ...
            ?>
                ...
                <div style="text-align: center;">
                    <hr>
                    <h5>Released Barangay Clearance (document)</h5>
                    <hr />
                </div>
                <!-- Search -->
                <div class="search_content">
                    ...
                    <div style="display: flex;" class="  select__select">
                        <img src="../img/back.png" onclick="javascript:history.go(-1);" title="Back?" class="hoverback" style="width: 45px; height: 45px;margin-left: 160px; cursor: pointer;" alt="Back?">
                    </div>
                </div>
                <!-- end of search form -->
                        ...
                        while ($stmt_paging->fetch()) { ?>
                            <tbody>
                                <tr class="table-row">
                                    ...
                                    <td><?php echo date("F d, Y", strtotime($data['app_date']));  ?></td>
                                    <td><input type="text" class="tblinput inpwidth" style="background-color: #e1edeb;color: black; border: 1px solid #4CAF50; border-radius: 20px;" value="<?php echo $data['clearance_status']; ?>"></td>
