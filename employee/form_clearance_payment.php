                ...
                <form method="POST" action="" class="body">
                                        <div class="main-content-email">
                                            ...
                                            <div class="main-content">
                                                ...
                                                <div class="information col">
                                                    <p> Subject: </p>
                                                    <input required class="form-control emailwidth" id="subject" name="subject" value="Payment: Barangay Clearance (Document Request)" type="text" placeholder="Enter Subject">
                                                </div>
                                            </div>
                                            ...
                                            <div class="information col">
                                                ...
                                                <p>
                                                Thanks for filling out the form. Your request has been approved. To proceed, we are issuing a payment for a document specifically (Barangay Clearance) with a total amount of <strong> ₱10 bill</strong>. For a payment we are accepting GCash and Paymaya! Here is the number:
                                                <br>
                                                <br>
                                                Tagalog (Translation)
                                                <br>
                                                Salamat sa pagsagot sa form. Natanggap na namin ang iyong request. Kami ay humihingi ng danyos para sa dokumento partikular na sa (Barangay Clearance) na may kabuohang halaga na <strong> ₱10 </strong>. Para sa pagbabayad kami ay tumatanggap ng GCash at Paymaya! Narito ang numero:
                                                <br>
                                                <br>
                                                ...
                                                <br>
                                                <br>
                                                Paymaya: http://comm-bms.com/payment_link/paymaya_clearance_payment.php?id=<?php echo $data['approved_clearanceids']; ?>
                                                <br>
                                                GCash: http://comm-bms.com/payment_link/gcash_clearance_payment.php?id=<?php echo $data['approved_clearanceids']; ?>
                                                <br>
                                                <br>
