...
<head>
    ...
    <title> Business Permit - Transaction History</title>
    ...
    <section class="home-section">
        ...
        <section class="top-section">
            <div class="top-content">
                <div>
                    <h5>Business Permit >> Transaction History
                        <a href="#" class="circle">
                            <img src="../img/dt.png">
                        </a>
                    </h5>
        ...
        <div id="content" class="container col-md-12">
            ...
            if (empty($keyword)) {
                $sql_query = "SELECT approved_bpermitid, dateissued, selection, fullname, contactno, businessname, businessaddress, plateno, email_add, businessid_image, bpermitid_type, permitfilechoice, approvedby, app_date, status,email_status, payment_stat
					FROM approved_bpermits WHERE status = 'Done'
            ...
            ?>
                ...
                <div style="text-align: center;">
                    <hr>
                    <h5>Released Business Permit (document)</h5>
                    <hr />
                </div>
                <!-- Search -->
