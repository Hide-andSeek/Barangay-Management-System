		  ...
		  <section class="home-section">
            ...
            <div>
                ...
                <div id="option_menu">
                      ...
                      <div class="information col" style="margin-bottom: 20px;">
                      ...
                      <label class="employee-label ">Attach 2x2 Pic</label>
                        ...
                        <input type="hidden" style="margin-bottom: 20px;" name="status" id="status" value="Approved">
                        <a><button style="margin-bottom: 10px;" class="btn btn-success font-sizee form-control btnmargin" name="insertindigency">Approve</button></a>
                  </form>
