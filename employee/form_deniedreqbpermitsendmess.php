...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
     ...
     <title> Denied Request: Business Permit </title>
		  ...
		  <section class="home-section">
			<!-- Top Section -->
			  <section class="top-section">
				  <div class="top-content">
					<div>
						<h5>Business Permit >> Denied: Business Permit >> Business Permit
						<a href="#" class="circle">
							 <img src="../img/dt.png" >
					    </a>
					    </h5>	  
            ...
            <div>
                ...
                <div style="float: right;">
                    <a href="businesspermitdenied.php">
                ...
                <form method="POST" action="" class="body">
                                        <div class="main-content-email">
                                            ...
                                            <div class="main-content">
                                                ...
                                                <div class="information col">
                                                    <p> Subject: </p>
                                                    <input required class="form-control emailwidth" id="subject" name="subject" value="Denied Request: Barangay Clearance (Document Request)" type="text" placeholder="Enter Subject">
                                                </div>
                                            </div>
