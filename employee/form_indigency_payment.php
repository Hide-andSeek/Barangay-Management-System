...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href='https://unpkg.com/boxicons@2.0.7/css/boxicons.min.css' rel='stylesheet'>
     ...
     <title> Make a Payment: Barangay Clearance </title>
			...
			<!-- Top Section -->
			  <section class="top-section">
				  <div class="top-content">
					<div>
						<h5>Barangay Clearance >> View Approved Details >> Make a Payment
						<a href="#" class="circle">
							 <img src="../img/dt.png" >
					    </a>
					    </h5>	  
                                        ...
                                        <div class="main-content-email">
                                            ...
                                            <div class="main-content">
                                                <div class="information col">
                                                    ...
                                                    <input class="form-control emailwidth" id="fullname" name="fullname" value="<?php echo $data['fullname']; ?>" type="text" placeholder="Enter Fullname">
                                                </div>

                                                <div class="information col">
                                                    <p> To: </p>
                                                    <input required class="form-control emailwidth" id="email" name="email" style="width:100%" value="<?php echo $data['emailaddress']; ?>" type="text" placeholder="Enter Email Address">
                                                </div>

                                                <div class="information col">
                                                    <p> Subject: </p>
                                                    <input required class="form-control emailwidth" id="subject" name="subject" value="Payment: Certificate of Indigency (Document Request)" type="text" placeholder="Enter Subject">
                                                </div>
                                            </div>
                                            ...
                                            <div class="information col">
                                                ...
                                                Good Day! Mr/Ms. <strong style="text-transform: uppercase"><?php echo $data['fullname']; ?></strong>    
                                                <p>
                                                Thanks for filling out the form. Your request has been approved. To proceed, we are issuing a payment for a document specifically (Certificate of Indigency) with a total amount of <strong> ₱10 bill</strong>. For a payment we are accepting GCash and Paymaya! Here is the number:
                                                <br>
                                                <br>
                                                Tagalog (Translation)
                                                <br>
                                                Salamat sa pagsagot sa form. Natanggap na namin ang iyong request. Kami ay humihingi ng danyos para sa dokumento partikular na sa (Certificate of Indigency) na may kabuohang halaga na <strong> ₱10 </strong>. Para sa pagbabayad kami ay tumatanggap ng GCash at Paymaya! Narito ang numero:
                                                <br>
                                                <br>
                                                ...
                                                <br>
                                                <br>
                                                Paymaya: http://comm-bms.com/payment_link/paymaya_indigency_payment.php?id=<?php echo $data['approvedindigency_id']; ?>
                                                <br>
                                                GCash: http://comm-bms.com/payment_link/gcash_indigency_payment.php?id=<?php echo $data['approvedindigency_id']; ?>
                                                <br>
                                                <br>
