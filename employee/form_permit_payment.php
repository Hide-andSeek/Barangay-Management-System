		  ...
		  <section class="home-section">
			<!-- Top Section -->
			  <section class="top-section">
				  <div class="top-content">
					<div>
						<h5>Business Permit >> View Approved Details >> Make a Payment
						<a href="#" class="circle">
							 <img src="../img/dt.png" >
					    </a>
					    </h5>	  
            ...
            <div>
                ...
                <div style="float: right;">
                    <a href="businesspermitapproval.php">
                ...
                <form method="POST" action="" class="body">
                                        <div class="main-content-email">
                                            ...
                                            <div class="main-content">
                                                ...
                                                <div class="information col">
                                                    <p> To: </p>
                                                    <input required class="form-control emailwidth" id="email" name="email" style="width:100%" value="<?php echo $data['email_add']; ?>" type="text" placeholder="Enter Email Address">
                                                </div>

                                                <div class="information col">
                                                    <p> Subject: </p>
                                                    <input required class="form-control emailwidth" id="subject" name="subject" value="Payment: Business Permit (Document Request)" type="text" placeholder="Enter Subject">
                                                </div>
                                            </div>
                                            ...
                                            <div class="information col">
                                                ...
                                                <p>
                                                Thanks for filling out the form. Your request has been approved. To proceed, we are issuing a payment for a document specifically (Business Permit) with a total amount of <strong> ₱10 bill</strong>. For a payment we are accepting GCash and Paymaya! Here is the number:
                                                <br>
                                                <br>
                                                Tagalog (Translation)
                                                <br>
                                                Salamat sa pagsagot sa form. Natanggap na namin ang iyong request. Kami ay humihingi ng danyos para sa dokumento partikular na sa (Business Permit) na may kabuohang halaga na <strong> ₱10 </strong>. Para sa pagbabayad kami ay tumatanggap ng GCash at Paymaya! Narito ang numero:
                                                <br>
                                                <br>
