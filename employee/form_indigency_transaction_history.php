...
<head>
    ...
    <title> Certificate of Indigency - Transaction History</title>
    ...
    <section class="home-section">
        ...
        <section class="top-section">
            <div class="top-content">
                <div>
                    <h5>Certificate of Indigency >> Transaction History
                        <a href="#" class="circle">
                            <img src="../img/dt.png">
                        </a>
                    </h5>
        ...
        <div id="content" class="container col-md-12">
            ...
            if (empty($keyword)) {
                $sql_query = "SELECT approvedindigency_id, fullname, address, purpose, contactnum, emailaddress, date_issue, indigencyid_image, indigencyfilechoice, approvedby, app_date, status, email_status,  payment_stat
					FROM approved_indigency WHERE status = 'Done'
            ...
            if (empty($keyword)) {
                $sql_query = "SELECT approvedindigency_id, fullname, address, purpose, contactnum, emailaddress, date_issue, indigencyid_image, indigencyfilechoice, approvedby, app_date, status, email_status,  payment_stat
					FROM approved_indigency WHERE status = 'Done'
					ORDER BY approvedindigency_id ASC LIMIT ?, ?";
            } else {
                $sql_query = "SELECT approvedindigency_id, fullname, address, purpose, contactnum, emailaddress, date_issue, indigencyid_image, indigencyfilechoice, approvedby, app_date, status, email_status,  payment_stat
					FROM approved_indigency 
					WHERE fullname LIKE ? 
            ...
            ?>
                ...
                <div style="text-align: center;">
                    <hr>
                    <h5>Released Certificate of Indigency (document)</h5>
                    <hr />
                </div>
                <!-- Search -->
