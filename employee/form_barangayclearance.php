...
<head>
	...
	<style>
		* {
		...
		.transact{margin-top: -100px; margin-left: 85%; margin-right: 5%;}
	</style>
</head>
	...
	<section class="home-section">
		...
		";
			...
			?>
				...
				<div class="search_content">
					...
					<div style="display: flex;" class="mrgn document-section select__select">
						<div style="margin-right: 10px;">
							<button class="btn btn-success viewbtn" onclick="window.location.href='clearanceapproval.php'"><i class="bx bx-xs bx-checkbox-checked" style="font-size: 20px;"></i>Approved</button>
						</div>
						<div>
							<button class="btn btn-danger viewbtn" onclick="window.location.href='clearancedenied.php'"><i class="bx bx-xs bx-checkbox-checked" style="font-size: 20px;"></i>Deny</button>
						</div>
					</div>
				</div>
				<!-- end of search form -->
				...
				<div class="transact">
					<button class="btn bg-olive viewbtn" onclick="window.location.href='clearance_transaction_history.php'"><i class="bx bx-xs bx-folder-open" style="font-size: 20px;"></i> Transaction History </button>
				</div>
		</div>
