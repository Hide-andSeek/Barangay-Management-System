                ...
                <form action="" method="post">
                    <div style="padding-top: 15px; width: 965px;  height: 344px;">
                        ...
                        <div style="margin-top: 100px; margin-left: 50px;">
                            <p style="margin-top: 100px;">TO WHOM IT MAY CONCERN: </p>
                        </div>
                        ...
                        <div style="margin-top: 5px;"><input type="text" class="borderstyle" style="border-bottom: 1px solid black; width: 75%; margin-left: 120px;padding-left: 50px; padding-left: 290px; text-transform: uppercase;" id="fullname" name="fullname" value="<?php echo $data['fullname']; ?>">
                            <p style="text-align: center;">(NAME OF THE OWNER)</p>
                        </div>
                        ...
                        <div style="margin-top: 30px; margin-left: 50px;"><label>And owner/proprietor of </label><input type="text" class="borderstyle" style="border-bottom: 1px solid black; width: 65%; padding-left: 175px; text-transform: uppercase;" id="businessname" name="businessname" value="<?php echo $data['businessname']; ?>">
                            <p style="text-align: center; margin-right: 80px;">(BUSINESS NAME)</p>
                        </div>
                        <div style="margin-left: 50px;"><label>Located at </label><input type="text" class="borderstyle" style="border-bottom: 1px solid black; width: 77%; padding-left: 30px; text-transform: uppercase;" id="businessaddress" name="businessaddress" value="<?php echo $data['businessaddress']; ?>">,<p>Barangay Commonwealth, District II, Quezon City.</p>
                        </div>
                        <div style="margin-top: 25px; margin-left: 120px;">This Clearance valid up to <input class="borderstyle" style="border-bottom: 1px solid black; width: 30%; text-align: center;" type="text" name="dateissued" id="dateissued" value="<?php echo date("F d, Y", strtotime($data['dateissued'])); ?>">unless revoked to a valid cause.</div>
                        ...
                        <div style="margin-top: 25px; margin-left: 120px;">Issued this <input class="borderstyle" style="text-align: center; border-bottom: 1px solid black; width: 45%;" type="text" name="dateissued" id="dateissued" value="<?php echo date("F d, Y", strtotime($data['dateissued'])); ?>">, Quezon City, Metro Manila, <br> <label style="margin-left: -68px;"></label> Philippines.</div>
                        ...
                        <div style="margin-left: 50px; text-align: justify;"><label for="">Date Issued:</label> <input type="text" name="" id="" class="borderstyle" style="border-bottom: 1px solid black; width: 17%;padding-left: 20px;" value="<?php echo date("F d, Y", strtotime($data['dateissued'])); ?>"> <label style="float: right;  margin-right: 280px; font-size: 16px;"><strong> MANUEL A. CO</strong></label></div>
                        ...
                        <div style="font-size: 13px; margin-top: 100px;">
                            <p>NOT VALID WITHOUT QR CODE </p>
                            <p> CONTACT PERSON: <strong> MARIE LEAN CRUZ</strong></p>
                            <p style="margin-left: 125px;"><em> Secretary of Punong Barangay</em></p>
                            <p style="margin-left: 125px;"><strong>Tel. No. 2839695, (02) 5871963</strong> </p>
                        </div>
