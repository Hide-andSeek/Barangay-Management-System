					...
					<div class="col-md-12">
							...
							<?php 
								...
								<tr class="table-row">
									...
									<td name="id_image"><img src="../img/fileupload_barangayid/<?php echo $data['id_image']; ?>" width="210" height="100"></td>
									<td><input class="form-control" style="width: 135px; font-size: 13px; user-select: none;" name="approvedby" value="<?php echo $user;?>"></td>
									<td><input type="text" class="tblinput inpwidth" style="background: teal; border-radius: 10px;" value="<?php echo $data ['status']; ?>"></td>
