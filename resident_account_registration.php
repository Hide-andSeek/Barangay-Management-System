                                                            ...
                                                            <fieldset>
                                                                 <div class="left_userpersonal_info left_userpersonal_info1 userpersonal">
                                                                    ...
                                                                    <div class="form-group selec">
                                                                        ...
                                                                        <input class="form-control form-text" type="password" id="txtConfirmPassword" placeholder="Confirm Password" onChange="checkPasswordMatch();">
  ...
  <script>
      function checkPasswordMatch() {
        ...
        if (password != confirmPassword)
            $("#divCheckPasswordMatch").html(" <div style='color: red; font-size: 11px;margin-left: 5px;'> Passwords do not match! </div>");
        else
            $("#divCheckPasswordMatch").html(" <div style='color: green; font-size: 11px; margin-left: 5px;'> Passwords match. </div>");
        }
